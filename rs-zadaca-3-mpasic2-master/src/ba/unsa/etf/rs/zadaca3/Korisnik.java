...
public class Korisnik {
    ...
    private SimpleBooleanProperty adminBox = new SimpleBooleanProperty(false);
    ...
    public boolean checkPassword() {
            ...
            if(getPassword().matches("(?=.*[a-z])(?=.*[A-Z])+.*[0-9]+.*")){
                    return true;}
            else{
                    return false;}
    ...
    public boolean isAdminBox() {
        return adminBox.get();
    }

    public SimpleBooleanProperty adminBoxProperty() {
        return adminBox;
    }
}
